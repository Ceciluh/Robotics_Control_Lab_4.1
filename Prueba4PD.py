...
def build_default_pid(joint_names=DEFAULT_JOINTS) -> JointPID:
    ...
    gains = {
    "shoulder_pan":  PIDGains(kp=0.8,  ki=0, kd=0.25, i_limit=2.0, tau_limit=8.0),
    "shoulder_lift": PIDGains(kp=0.35, ki=0, kd=0.90, i_limit=2.0, tau_limit=18.0),
    "elbow_flex":    PIDGains(kp=0.2,  ki=0, kd=0.95, i_limit=2.0, tau_limit=15.0),
    "wrist_flex":    PIDGains(kp=1.3,  ki=0, kd=0.2,  i_limit=2.0, tau_limit=6.0),
    "wrist_roll":    PIDGains(kp=0.4,  ki=0, kd=0.18, i_limit=2.0, tau_limit=3.0),
    }
