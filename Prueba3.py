...
def build_default_pid(joint_names=DEFAULT_JOINTS) -> JointPID:
    ...
    gains = {
    "shoulder_pan":  PIDGains(kp=3.5, ki=0.12, kd=0.0, i_limit=2.0, tau_limit=8.0),
    "shoulder_lift": PIDGains(kp=1.5, ki=0.08, kd=0.0, i_limit=2.0, tau_limit=18.0),
    "elbow_flex":    PIDGains(kp=2.5, ki=-0.10, kd=0.0, i_limit=2.0, tau_limit=15.0),
    "wrist_flex":    PIDGains(kp=0.3, ki=0.10, kd=0.0, i_limit=2.0, tau_limit=6.0),
    "wrist_roll":    PIDGains(kp=2.2, ki=0.12, kd=0.0, i_limit=2.0, tau_limit=3.0),
}
