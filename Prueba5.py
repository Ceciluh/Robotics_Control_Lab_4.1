...
def build_default_pid(joint_names=DEFAULT_JOINTS) -> JointPID:
    ...
    gains = {
    "shoulder_pan":  PIDGains(kp=2.0, ki=0.06, kd=0.0, i_limit=2.0, tau_limit=8.0),
    "shoulder_lift": PIDGains(kp=1.6, ki=0.07, kd=0.0, i_limit=2.0, tau_limit=18.0),
    "elbow_flex":    PIDGains(kp=2.4, ki=-0.06, kd=0.0, i_limit=2.0, tau_limit=15.0),
    "wrist_flex":    PIDGains(kp=1.4, ki=0.05, kd=0.0, i_limit=2.0, tau_limit=6.0),
    "wrist_roll":    PIDGains(kp=1.2, ki=0.07, kd=0.0, i_limit=2.0, tau_limit=3.0),
}
